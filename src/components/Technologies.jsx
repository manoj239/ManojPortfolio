...
const technologies = [
  ...
  { name: "CI/CD", icon: "cicd", color: "from-green-500 to-emerald-600" },
  ...
  { name: "SQL", icon: "sql", color: "from-blue-500 to-indigo-600" },
  { name: "Redis", icon: "redis", color: "from-red-500 to-red-700" },

  { name: "Monitoring", icon: "monitoring", color: "from-teal-500 to-cyan-600" },
